...
3. Verification: Once complete, provide a concise summary of your changes in your final response and then run 'bd close {objective_id}' to signal job completion to the Adjutant engine.
