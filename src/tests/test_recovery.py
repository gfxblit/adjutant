...
class TestRecovery(unittest.TestCase):
    ...
    def test_recover_orphaned_scvs(self, mock_cleanup, mock_is_running, mock_listdir, mock_exists, mock_isdir):
        ...
        file_contents = {
            registry_path: json.dumps(registry_data),
        ...
        class MockFile:
            ...
            def write(self, data):
                written_contents[self.path] = written_contents.get(self.path, "") + data
        ...
        self.assertIn(registry_path, written_contents)
        updated_registry = json.loads(written_contents[registry_path])
